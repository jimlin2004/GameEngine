...
void GameEngine::FrameBuffer::generate()
{
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, this->specification.width, this->specification.height, 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr);
    ...
    glTexStorage2D(GL_TEXTURE_2D, 1, GL_DEPTH24_STENCIL8, this->specification.width, this->specification.height);
