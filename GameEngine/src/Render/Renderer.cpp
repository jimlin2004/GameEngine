...
void GameEngine::Renderer::initQuad()
{
    ...
    rendererData.quadShader->generateShader("./assets/shader/quad/quad.vs", "./assets/shader/quad/quad.fs");
...
void GameEngine::Renderer::initLine()
{
    ...
    rendererData.lineShader->generateShader("./assets/shader/line/line.vs", "./assets/shader/line/line.fs");
...
void GameEngine::Renderer::drawQuad(const glm::mat4 &transform, const glm::vec4 &color, int entityID)
{
    ...
    for (int i = 0; i < 4; ++i)
    {
        rendererData.quadVertexBufferPtr->position = transform * rendererData.quadVertexUnitPoint[i];
