...
{
    GAMEENGINE_BEGIN()
    this->testActor = GameEngine::globalScene->spawnActor<TestActor>({300.0f, 300.0f, 1.0f}, {50.0f, 50.0f, 1.0f}, {0.0f, 0.0f, 0.0f}, "TestActor");
    ...
    GameEngine::globalScene->spawnActor<TestActor>({400.0f, 300.0f, 1.0f}, {50.0f, 50.0f, 1.0f}, {0.0f, 0.0f, 45.0f}, "TestActor2");
}
